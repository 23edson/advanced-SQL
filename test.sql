...
create database teste owner master;

\c teste postgres;

create tablespace "t_userbbb" OWNER  master LOCATION  '/var/lib/postgresql/';  --Cria tablespace no local ''/var/lib/postgresql/9.1/main''
